...
final class MatsimClassCustomSimWrapperRunner2 implements MATSimAppCommand {

	private static final Logger log = LogManager.getLogger(MatsimClassCustomSimWrapperRunner2.class);
	...
	private MatsimClassCustomSimWrapperRunner2(){
	}
...
//			renameExistingDashboardYAMLs(runDirectory);
			...
			sw.addDashboard(new MatsimClassCustomDashboard2());
	...
	public static void main(String[] args) {
		new MatsimClassCustomSimWrapperRunner2().execute(args);
