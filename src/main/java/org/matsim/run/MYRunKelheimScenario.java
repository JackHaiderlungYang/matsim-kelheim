...
@CommandLine.Command(header = ":: Open Kelheim Scenario ::", version = MYRunKelheimScenario.VERSION, mixinStandardHelpOptions = true)
...
public class MYRunKelheimScenario extends MATSimApplication {
	...
	public MYRunKelheimScenario(@Nullable Config config) {
		super(config);
	}

	public MYRunKelheimScenario() {
		super(String.format("input/v%s/kelheim-v%s-config.xml", VERSION, VERSION));
	}

	public static void main(String[] args) {
		MATSimApplication.run(MYRunKelheimScenario.class, args);
	}
